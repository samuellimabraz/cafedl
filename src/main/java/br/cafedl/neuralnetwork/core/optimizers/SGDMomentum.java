...
public class SGDMomentum extends Optimizer {
    ...
    public SGDMomentum(double learningRate) {
        this(learningRate, 0.9);
    }

    public SGDMomentum(LearningRateDecayStrategy learningRateDecayStrategy, double momentum) {
        super(learningRateDecayStrategy);
        this.momentum = momentum;
    }

    public SGDMomentum(LearningRateDecayStrategy learningRateDecayStrategy) {
        this(learningRateDecayStrategy, 0.9);
    }

    /**
     * Create auxiliary parameters for SGDMomentum optimizer
     *
     * <p>
    ...
    protected List<INDArray>  createAuxParams(INDArray params) {
        ...
        auxParams.add(Nd4j.zeros(DataType.DOUBLE, params.shape())); // velocities
        return auxParams;
    }

    /**
     * Update rule for SGDMomentum optimizer
     *
     * <p>
